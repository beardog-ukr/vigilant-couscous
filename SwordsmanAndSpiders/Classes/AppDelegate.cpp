...
#endif // if USE_AUDIO_ENGINE && USE_SIMPLE_AUDIO_ENGINE
...
bool AppDelegate::applicationDidFinishLaunching() {
  ...
  if (!glview) {
    ...
    glview =
      GLViewImpl::createWithRect("SwordsmanAndSpiders",
                                 cocos2d::Rect(0, 0, designResolutionSize.width,
                                               designResolutionSize.height));
#else // if (CC_TARGET_PLATFORM == CC_PLATFORM_WIN32) || (CC_TARGET_PLATFORM ==
      // CC_PLATFORM_MAC) || (CC_TARGET_PLATFORM == CC_PLATFORM_LINUX)
    glview = GLViewImpl::create("SwordsmanAndSpiders");
#endif // if (CC_TARGET_PLATFORM == CC_PLATFORM_WIN32) || (CC_TARGET_PLATFORM ==
       // CC_PLATFORM_MAC) || (CC_TARGET_PLATFORM == CC_PLATFORM_LINUX)
